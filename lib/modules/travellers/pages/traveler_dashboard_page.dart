import 'package:daryaft_flutter/modules/travellers/controllers/travelers_dashboard_controller.dart';
import 'package:daryaft_flutter/modules/travellers/pages/traveler_bookings_page.dart';
import 'package:daryaft_flutter/modules/travellers/pages/traveler_home_page.dart';
import 'package:daryaft_flutter/modules/travellers/pages/traveler_more_settings_page.dart';
import 'package:daryaft_flutter/modules/travellers/pages/traveler_services_packages_page.dart';
...
class TravelerDashBoardPage extends GetView<TravelersDashboardController> {
  ...
  static final List<Widget> _widgetOptions = <Widget>[
    ...
    const TravelerServicesPackagePage(),
    const TravelerBookingPage(),
    const TravelerMoreSettingsPage(),
  ];
}
